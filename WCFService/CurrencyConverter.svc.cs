...
namespace WCFService
{
    ...
    {
        public IList<SelectListItem> GetCountryDropDown()
        {
        ...
        public decimal ConvertToGoogle(decimal amount, string fromCurrency, string toCurrency)
        {
        ...
        public decimal ConvertToYahoo(decimal amount, string fromCurrency, string toCurrency)
        {
            WebClient web = new WebClient();
